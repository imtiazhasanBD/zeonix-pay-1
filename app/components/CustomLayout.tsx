  ...
  return (
    <div className="flex bg-gray-100 min-h-screen gap-6 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
      ...
      <div className={`flex flex-col w-full transition-all duration-300 ease-in-out`}>
        ...
        <main className={`flex-1 p-4 md:p-6 ${collapsed ? 'lg:ml-20' : 'lg:ml-64'} transition-all duration-300 ease-in-out scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100`}>{children}</main>
      </div>
    </div>
  );
};
