...
const initialUsers: User[] = [
  { id: "u1", name: "Imran Hossain", email: "imran@example.com", phone: "01700000000", balance: "$500", status: "active", role: "Customer" },
  { id: "u2", name: "Tanzila Akter", email: "tanzila@example.com", phone: "01700000001", balance: "$1000", status: "inactive", role: "Merchant" },
  { id: "u3", name: "Rafiul Islam", email: "rafiul@example.com", phone: "01700000002", balance: "$1500", status: "active", role: "Customer" },
];
      ...
      <div className="rounded-sm bg-white overflow-hidden">
        <Table className="min-w-full text-sm">
          <TableHeader className="bg-gray-100">
            <TableRow className="bg-customViolet hover:bg-customViolet text-white">
              <TableHead className="w-[20%] text-white">Name</TableHead>
              <TableHead className="w-[25%] text-white">Email</TableHead>
              <TableHead className="w-[20%] text-white">Phone</TableHead>
              <TableHead className="w-[15%] text-white">Balance</TableHead>
              <TableHead className="w-[15%] text-white">Status</TableHead>
              <TableHead className="w-[20%] text-white">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {currentRows.map((row) => (
